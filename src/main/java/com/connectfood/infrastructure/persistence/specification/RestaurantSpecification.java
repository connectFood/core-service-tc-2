...
public final class RestaurantSpecification {
  ...
  public static Specification<RestaurantEntity> nameContains(final String name) {
    return likeIgnoreCase("name", name);
  }

  public static Specification<RestaurantEntity> hasRestaurantsTypeUuid(final UUID restaurantsTypeUuid) {
  ...
  public static Specification<RestaurantEntity> cityContains(final String city) {
    if (city == null) {
      return null;
    }
  ...
  public static Specification<RestaurantEntity> stateContains(final String state) {
    if (state == null) {
      return null;
    }
  ...
  public static Specification<RestaurantEntity> streetContains(final String street) {
    if (street == null) {
      return null;
    }
