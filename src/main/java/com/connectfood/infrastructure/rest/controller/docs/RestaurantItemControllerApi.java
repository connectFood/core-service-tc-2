...
public interface RestaurantItemControllerApi {
  ...
  ResponseEntity<PageResponse<List<RestaurantItemResponse>>> search(
  ...
  ResponseEntity<BaseResponse<RestaurantItemResponse>> findByUuid(@PathVariable final UUID uuid);
  ...
  ResponseEntity<BaseResponse<RestaurantItemResponse>> create(
      @RequestHeader(name = "Request-User-Uuid") final UUID requestUserUuid,
      @Valid @RequestBody final RestaurantItemRequest request);
  ...
  ResponseEntity<BaseResponse<RestaurantItemResponse>> update(
      @RequestHeader(name = "Request-User-Uuid") final UUID requestUserUuid,
      @PathVariable final UUID uuid, @Valid @RequestBody final RestaurantItemRequest request);
