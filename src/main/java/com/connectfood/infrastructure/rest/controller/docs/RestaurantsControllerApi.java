...
public interface RestaurantsControllerApi {
  ...
  ResponseEntity<PageResponse<List<RestaurantsResponse>>> search(
  ...
  ResponseEntity<BaseResponse<RestaurantsResponse>> findByUuid(@PathVariable final UUID uuid);
  ...
  ResponseEntity<BaseResponse<RestaurantsResponse>> create(
  ...
  ResponseEntity<BaseResponse<RestaurantOpeningHoursResponse>> createOpeningHours(
      @RequestHeader(name = "Request-User-Uuid") final UUID requestUserUuid,
      @PathVariable final UUID uuid, @Valid @RequestBody final RestaurantOpeningHoursRequest request);
  ...
  ResponseEntity<BaseResponse<RestaurantsResponse>> update(
      @RequestHeader(name = "Request-User-Uuid") final UUID requestUserUuid,
      @PathVariable final UUID uuid, @Valid @RequestBody final RestaurantsRequest request);
  ...
  ResponseEntity<BaseResponse<RestaurantOpeningHoursResponse>> update(
      @RequestHeader(name = "Request-User-Uuid") final UUID requestUserUuid,
      @PathVariable final UUID openingHoursUuid, @Valid @RequestBody final RestaurantOpeningHoursRequest request);
