...
@RestController
public class UsersTypeController implements UsersTypeControllerApi {
  ...
  @Override
  public ResponseEntity<BaseResponse<UsersTypeResponse>> findByUuid(final UUID uuid) {
  ...
  @Override
  public ResponseEntity<BaseResponse<UsersTypeResponse>> create(final UsersTypeRequest request) {
  ...
  public ResponseEntity<BaseResponse<UsersTypeResponse>> update(
      final UUID uuid, final UsersTypeRequest request) {
