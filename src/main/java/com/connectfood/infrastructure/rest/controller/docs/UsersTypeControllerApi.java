...
public interface UsersTypeControllerApi {
  ...
  ResponseEntity<PageResponse<List<UserTypeResponse>>> search(
  ...
  ResponseEntity<BaseResponse<UserTypeResponse>> findByUuid(@PathVariable final UUID uuid);
  ...
  ResponseEntity<BaseResponse<UserTypeResponse>> create(@Valid @RequestBody final UserTypeRequest request);
  ...
  ResponseEntity<BaseResponse<UserTypeResponse>> update(
      @PathVariable final UUID uuid, @Valid @RequestBody final UserTypeRequest request);
