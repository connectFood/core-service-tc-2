...
@Getter
public class UsersAddressOutput {
  ...
  public UsersAddressOutput(final UUID uuid, final String street, final String number, final String complement,
      final String neighborhood, final String city, final String state, final String country, final String zipCode,
      final UsersOutput users) {
    this.uuid = uuid;
    this.street = street;
    this.number = number;
