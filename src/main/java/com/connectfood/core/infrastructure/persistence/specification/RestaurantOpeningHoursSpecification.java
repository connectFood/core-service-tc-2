...
public final class RestaurantOpeningHoursSpecification {

  private RestaurantOpeningHoursSpecification() {
  }

  public static Specification<RestaurantOpeningHoursEntity> hasRestaurantUuid(final UUID restaurantUuid) {
