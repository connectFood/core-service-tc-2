...
class UserTypeEntryMapperTest {

  private final UserTypeEntryMapper mapper = new UserTypeEntryMapper();
  ...
  void shouldConvertToInputWhenRequestIsProvided() {
    final UserTypeRequest request = org.mockito.Mockito.mock(UserTypeRequest.class);
  ...
  void shouldReturnNullWhenOutputIsNull() {
    final UserTypeResponse result = mapper.toResponse(null);
  ...
  void shouldConvertToResponseWhenOutputIsProvided() {
    ...
    final UserTypeResponse result = mapper.toResponse(output);
