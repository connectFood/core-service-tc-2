...
class UserControllerTest {
  ...
  void shouldReturnOkWithPageResponseWhenHasResults() {
    ...
    final UserResponse resp1 = Mockito.mock(UserResponse.class);
    final UserResponse resp2 = Mockito.mock(UserResponse.class);
    ...
    final PageResponse<List<UserResponse>> body = result.getBody();
  ...
  void shouldReturnOkWithBaseResponseWhenFindByUuid() {
    ...
    final BaseResponse<UserResponse> body = result.getBody();
    Assertions.assertNotNull(body);
