...
class RestaurantItemSpecificationTest {
  ...
  void shouldReturnNullWhenRestaurantUuidIsNull() {
    final Specification<RestaurantItemEntity> spec =
        RestaurantItemSpecification.hasRestaurantUuid(null);
  ...
  void shouldCreatePredicateWhenRestaurantUuidIsProvided() {
    ...
    final Root<RestaurantItemEntity> root = Mockito.mock(Root.class);
    ...
    final Specification<RestaurantItemEntity> spec =
        RestaurantItemSpecification.hasRestaurantUuid(restaurantUuid);
