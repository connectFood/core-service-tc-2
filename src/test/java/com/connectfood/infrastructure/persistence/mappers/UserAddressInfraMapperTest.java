...
class UserAddressInfraMapperTest {
  ...
  void toDomainShouldMapEntityToDomainCorrectly() {
    ...
    final var usersEntity = Mockito.mock(UserEntity.class);
    ...
    final var entity = Mockito.mock(UserAddressEntity.class);
  ...
  void toEntityShouldReturnNullWhenUsersEntityIsNull() {
    ...
    final UserAddressEntity result = mapper.toEntity(UUID.randomUUID(), null, addressEntity);
  ...
  void toEntityShouldReturnNullWhenAddressEntityIsNull() {
    ...
    final UserAddressEntity result = mapper.toEntity(UUID.randomUUID(), usersEntity, null);
  ...
  void toEntityShouldMapToEntityCorrectlyWhenDataIsValid() {
    ...
    final UserAddressEntity result = mapper.toEntity(uuid, usersEntity, addressEntity);
