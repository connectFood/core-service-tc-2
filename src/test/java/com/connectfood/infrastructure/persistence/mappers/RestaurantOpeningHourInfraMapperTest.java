...
class RestaurantOpeningHourInfraMapperTest {

  private final RestaurantOpeningHourInfraMapper mapper = new RestaurantOpeningHourInfraMapper();

  @Test
  @DisplayName("Deve criar o mapper pelo construtor padrão")
  void shouldCreateMapperUsingDefaultConstructor() {
    final var instance = new RestaurantOpeningHourInfraMapper();
