...
class RestaurantsTypeInfraMapperTest {

  private final RestaurantsTypeInfraMapper mapper = new RestaurantsTypeInfraMapper();

  @Test
  @DisplayName("Deve criar o mapper pelo construtor padrão")
  void shouldCreateMapperUsingDefaultConstructor() {
    final var instance = new RestaurantsTypeInfraMapper();
  ...
  void toDomainShouldMapEntityToDomainCorrectly() {
    ...
    final var entity = new RestaurantsTypeEntity();
    entity.setUuid(uuid);
    entity.setName("TYPE");
  ...
  void toEntityShouldReturnNullWhenModelIsNull() {
    final RestaurantsTypeEntity result = mapper.toEntity(null);
  ...
  void toEntityShouldMapModelToEntityCorrectly() {
    ...
    final RestaurantsTypeEntity result = mapper.toEntity(model);
  ...
  void toEntityWithExistingEntityShouldUpdateFields() {
    ...
    final RestaurantsTypeEntity result = mapper.toEntity(model, entity);
