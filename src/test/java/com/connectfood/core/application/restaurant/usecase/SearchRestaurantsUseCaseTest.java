...
class SearchRestaurantsUseCaseTest {
  ...
  void shouldReturnPageOutputWithMappedResultsAndTotal() {
    ...
    final RestaurantOutput output1 = Mockito.mock(RestaurantOutput.class);
    final RestaurantOutput output2 = Mockito.mock(RestaurantOutput.class);
    ...
    final PageOutput<List<RestaurantOutput>> result = useCase.execute(
        name,
        restaurantsTypeUuid,
        street,
        city,
