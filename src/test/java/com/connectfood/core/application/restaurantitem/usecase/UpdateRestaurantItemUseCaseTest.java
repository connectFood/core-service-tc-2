...
class UpdateRestaurantItemUseCaseTest {
  ...
  void shouldThrowNotFoundExceptionWhenRestaurantItemsDoesNotExist() {
    ...
    final var input = Mockito.mock(RestaurantItemInput.class);
  ...
  void shouldUpdateRestaurantItemsWhenExistsAndReturnOutputWithoutImages() {
    ...
    final RestaurantItemOutput expected = Mockito.mock(RestaurantItemOutput.class);
  ...
  void shouldSyncImagesUpdateKeepSaveDeleteAndSkipNullDelete() {
    ...
    final RestaurantItemImageInput inKeep = Mockito.mock(RestaurantItemImageInput.class);
    ...
    final RestaurantItemImageInput inUpdate = Mockito.mock(RestaurantItemImageInput.class);
    Mockito.when(inUpdate.getUuid())
        .thenReturn(updateUuid);
    Mockito.when(inUpdate.getName())
        .thenReturn("new-name");

    final RestaurantItemImageInput inNew = Mockito.mock(RestaurantItemImageInput.class);
    ...
    Mockito.when(restaurantItemsImagesMapper.toDomain(Mockito.any(RestaurantItemImageInput.class)))
    ...
    final RestaurantItemOutput expectedOutput = Mockito.mock(RestaurantItemOutput.class);
    ...
    Mockito.verify(restaurantItemsImagesMapper, Mockito.times(3))
        .toDomain(Mockito.any(RestaurantItemImageInput.class));
  ...
  void shouldThrowNotFoundExceptionWhenIncomingImageUuidNotFoundInCurrent() {
    ...
    final RestaurantItemImageInput incoming = Mockito.mock(RestaurantItemImageInput.class);
