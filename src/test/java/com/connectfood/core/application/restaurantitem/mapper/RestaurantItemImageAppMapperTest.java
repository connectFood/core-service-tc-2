...
class RestaurantItemImageAppMapperTest {

  @InjectMocks
  private RestaurantItemImageAppMapper mapper;

  @Test
  @DisplayName("Não deve criar domínio quando input for nulo")
  void shouldReturnNullWhenInputIsNull() {
    final var result = mapper.toDomain((RestaurantItemImageInput) null);
  ...
  void shouldCreateDomainFromInput() {
    final var input = Mockito.mock(RestaurantItemImageInput.class);
  ...
  void shouldCreateOutputFromDomain() {
    ...
    final RestaurantItemImageOutput result = mapper.toOutput(model);
