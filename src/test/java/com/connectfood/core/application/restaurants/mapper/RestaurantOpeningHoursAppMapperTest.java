...
class RestaurantOpeningHoursAppMapperTest {
  ...
  private final RestaurantOpeningHoursAppMapper mapper = new RestaurantOpeningHoursAppMapper();

  @Test
  @DisplayName("Deve criar o mapper pelo construtor padrão")
  void shouldCreateMapperUsingDefaultConstructor() {
    final var instance = new RestaurantOpeningHoursAppMapper();
  ...
  void toOutputShouldMapModelToOutputCorrectly() {
    ...
    final RestaurantOpeningHoursOutput result = mapper.toOutput(model);
