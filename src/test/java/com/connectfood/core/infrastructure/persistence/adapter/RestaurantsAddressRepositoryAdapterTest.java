...
class RestaurantsAddressRepositoryAdapterTest {
  ...
  @InjectMocks
  private RestaurantsAddressRepositoryAdapter adapter;
  ...
  void saveShouldPersistAndReturnMappedModel() {
    ...
    Mockito.when(restaurantsDomain.getUuid())
    ...
    Mockito.when(restaurantsAddress.getRestaurants())
