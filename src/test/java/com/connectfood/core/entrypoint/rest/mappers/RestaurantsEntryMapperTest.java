...
class RestaurantsEntryMapperTest {
  ...
  void shouldConvertToInputWhenRequestIsProvided() {
    ...
    final RestaurantOpeningHoursRequest opening1 = Mockito.mock(RestaurantOpeningHoursRequest.class);
    final RestaurantOpeningHoursRequest opening2 = Mockito.mock(RestaurantOpeningHoursRequest.class);
  ...
  void shouldConvertToResponseWhenAllFieldsArePresent() {
    ...
    final RestaurantOpeningHoursResponse openingResp1 = Mockito.mock(RestaurantOpeningHoursResponse.class);
    final RestaurantOpeningHoursResponse openingResp2 = Mockito.mock(RestaurantOpeningHoursResponse.class);
