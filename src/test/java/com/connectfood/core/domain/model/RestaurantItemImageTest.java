...
class RestaurantItemImageTest {
  ...
  void shouldCreateRestaurantItemsImagesWithExplicitUuid() {
    ...
    final var image = new RestaurantItemImage(uuid, name, description, path);
  ...
  void shouldCreateRestaurantItemsImagesWithoutExplicitUuid() {
    ...
    final var image = new RestaurantItemImage(name, description, path);
  ...
  void shouldNotCreateRestaurantItemsImagesWithoutNameAndThrowBadRequestException() {
    final var exception = Assertions.assertThrows(
        ...
        () -> new RestaurantItemImage(UUID.randomUUID(), null, "Image description", "/items/image.png")
    );
  ...
  void shouldNotCreateRestaurantItemsImagesWithNameBlankAndThrowBadRequestException() {
    final var exception = Assertions.assertThrows(
        BadRequestException.class,
        () -> new RestaurantItemImage(UUID.randomUUID(), "   ", "Image description", "/items/image.png")
    );
  ...
  void shouldNotCreateRestaurantItemsImagesWithoutPathAndThrowBadRequestException() {
    final var exception = Assertions.assertThrows(
        BadRequestException.class,
        () -> new RestaurantItemImage(UUID.randomUUID(), "IMAGE_01", "Image description", null)
    );
  ...
  void shouldNotCreateRestaurantItemsImagesWithPathBlankAndThrowBadRequestException() {
    final var exception = Assertions.assertThrows(
        BadRequestException.class,
        () -> new RestaurantItemImage(UUID.randomUUID(), "IMAGE_01", "Image description", "")
    );
